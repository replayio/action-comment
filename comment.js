...
async function comment({
  ...
  const body = dedent`<picture>
  <source media="(prefers-color-scheme: light)" srcset="https://static.replay.io/images/logo-horizontal-small-light.svg">
  <img src="https://static.replay.io/images/logo-horizontal-small-light.svg">
  </picture>
...
function generateDetailsString(recordings, isPassed) {
  const summary = isPassed ? 
    dedent`
      <summary>
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://user-images.githubusercontent.com/15959269/177834869-851c4e78-e9d8-4ea3-bc1d-5bc372ab593a.png">
    ...
    dedent`
      <summary>
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://user-images.githubusercontent.com/15959269/177835072-8cafcea8-146d-410a-b02e-321390e8bd95.png">
